...
export default function DashboardManager() {
  ...
  const fetchChartData = useCallback(async () => {
    ...
    try {
      ...
      console.log("Inventory Summary fetched:", inventoryRes.data); // Log data yang diambil
      ...
      console.log("Metrics fetched:", metricsRes.data); // Log data metrik

      setLoadingCharts(false);
    } catch (err) {
      console.error("Error fetching chart data:", err); // Log error lebih awal
  ...
  // Initial load
  useEffect(() => {
    console.log("useEffect for initial load executed"); // Log useEffect ini
  ...
  useEffect(() => {
    console.log("useEffect for auto-refresh registered"); // Log useEffect ini
  ...
  const handleRefresh = () => {
    console.log("Refresh button clicked"); // Log klik refresh
    fetchChartData();
  };
